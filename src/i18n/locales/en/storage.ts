...
export const enStorage = {
  ...
  "nas.create.open": "Add subdataset",
  "nas.create.title": "Add NAS subdataset",
  "nas.create.subtitle": "Choose a parent dataset and configure the new storage.",
  "nas.create.form.title": "New subdataset",
  "nas.create.form.subtitle": "The subdataset will be created below the selected NAS dataset.",
  "nas.create.parent": "Parent dataset",
  "nas.create.parent.placeholder": "Select parent dataset",
  "nas.create.name": "Subdataset name",
  "nas.create.refquota": "Reference quota (GiB)",
  "nas.create.recordsize": "Record size (KiB)",
  "nas.create.automount": "Automatically mount below parent mounts",
  "nas.create.compression": "Compression",
  "nas.create.atime": "Access time",
  "nas.create.relatime": "Relative access time",
  "nas.create.submit": "Create subdataset",
  "nas.create.success": "Subdataset creation started",
  "nas.create.error": "Failed to create subdataset",
  "nas.create.load_error.title": "Failed to load NAS datasets",
  "nas.create.validation.parent": "Select a parent dataset.",
  "nas.create.validation.name": "Enter a subdataset name.",
  "nas.create.validation.properties": "Enter a valid quota and record size between 4 and 128 KiB.",
  "nas.create.empty.title": "No parent dataset is available",
  "nas.create.empty.body": "You need a NAS dataset under which the subdataset can be created first.",
